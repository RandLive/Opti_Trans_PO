...
options=optimset('Algorithm','trust-region-reflective','TolFun',1e-12,'MaxFunEvals',20000,'MaxIter',20000,'Display','off','UseParallel','never');   % Option to display output
